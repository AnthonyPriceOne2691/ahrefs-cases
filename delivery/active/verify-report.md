...
| Бэкенд целиком | `pytest -q` на своей копии дев-базы (`cases_casestage_tests`) | 722 passed, 3 skipped (на основе #27 до правки на той же копии — 714 passed, 3 skipped) |
