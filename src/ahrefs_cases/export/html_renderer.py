...
POINTS_NOTE = (
    ...
    "кривая ведёт от А к Б, а между ними ломается по измеренным месяцам."
)
"""Что показывает рисунок и откуда на нём крайние числа.
...
там, где его нет. Теперь кривая ведёт от точки А к точке Б, то есть числа
таблицы стоят на её концах, а сноска объясняет, что это средние по окну (Z32)."""
