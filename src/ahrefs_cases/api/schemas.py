...
class RunRow(BaseModel):
    ...
    chain: bool = False
    """Прогон — ступень цепочки «Довести до кейсов»: следующие ступени пойдут сами."""

    continues: bool = False
    """Цепочка пойдёт дальше: это самый новый прогон, ступень цепочки, кончилась
    не сборкой и только что. Экран опрашивает журнал, пока прогон идёт, и без
    этого признака перестал бы в щели между ступенями (урок L228)."""
