/**
 * Листание страниц. Одна на все экраны со списками.
 *
 * Страницы, а не бесконечная лента: у сервера жёсткий потолок выдачи, и лента
 * скрыла бы от человека, что он видит не всё.
 *
 * Живёт отдельно от экрана проектов с 14.09.2026: листание понадобилось
 * кейсам, и копия расходится с оригиналом на первой же правке — хотя бы в том,
 * с какой страницы считать номер (урок L75).
 */
