 ...
 * фильтр выбора файла, а тест сервера (`tests/test_intake_list_format.py`)
 * сверяет их с тем, чего требует приём, читая оба места (урок L123). Прежде
 * словарь жил внутри справки о таблице — копия, ждавшая второго читателя (L97);
 * второй пришёл.
 *
