...
def test_window_averaging_understates_linear_growth() -> None:
    """D15: усреднение окон систематически занижает линейный рост.
...
def test_table_reacts_to_thresholds() -> None:
    """D13, канарейка: таблица судит по порогам, а не по имени сценария.
...
def test_scenarios_are_not_tuned_to_thresholds() -> None:
    """D13: формы сценариев остались теми, что зафиксированы в Ф2а.
